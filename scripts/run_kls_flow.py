...
def main() -> None:
    ...
    (OUT / "report.md").write_text(
        ...
        "como resultado del programa). Consecuencia falsable dentro "
        "del modelo: el disparo de cada colapso de la Década no es "
        "instantáneo en el cruce — lleva un retraso universal fijado "
        "por el ritmo del flujo de acoplos.\n\n"
        "## Estatuto (frente 2)\n\n"
        f"{STATUS_LAMBDA}.\n\n"
