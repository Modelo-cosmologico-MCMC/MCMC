...
def render_matrix(reg: dict) -> str:
    lines = [
        ...
        "estatutos siguen la fe de erratas epistemológica del tratado "
        "(reclasificaciones E1–E13): «interna demostrada» = "
...
def render_ontology(reg: dict) -> str:
    ...
    lines = [
        ...
        "Vocabulario de estatutos de la fe de erratas epistemológica "
        "(E1–E13); tres categorías negativas "
