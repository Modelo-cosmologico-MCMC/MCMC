# Frente F: RP con acoplos no estacionarios (juguete del frente nº 1)

Cadena escalar de 2·3+1 sitios, funcionales de la loncha ±1, contracción exacta por matrices de transferencia. El sector espinorial de Wilson (Teo. 7.4) NO se toca: esto es el análogo escalar de la pregunta del frente.
...
El caso físico — acoplos que corren con S — con la reflexión ingenua (que no refleja el perfil):
...
La violación es continua (minúscula a g pequeño) y crece monótonamente con el gradiente. Curva medida; no se reclama ley simple.
