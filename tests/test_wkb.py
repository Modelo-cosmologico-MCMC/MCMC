...
def test_T_F2_C1():
    """|T_1^(F2)| ≈ 4.30e-4 dentro del 0.1%."""
    assert abs(transmission("F2", "C1") - 4.3e-4) / 4.3e-4 < 1e-3


def test_T_F3_C2():
    """|T_2^(F3)| ≈ 2.10e-3."""
    assert abs(transmission("F3", "C2") - 2.1e-3) / 2.1e-3 < 1e-3
