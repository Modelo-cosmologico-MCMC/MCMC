...
| Crosscheck JAX del fondo (6A-P3) | Ap. A + A.7 | `validation/jax_background.py` | `tests/test_jax_crosscheck.py` | equivalencia bajo puertas predeclaradas (PASS: álgebra 4e-16, vector 1.2e-14, |Δχ²| ≤ 6.9e-11 en los argmin publicados); integrador DESI de producción cazado (4.9e-8) y corregido a O(h⁴); integrador SNe medido (3e-6, sin puerta) — interna (E8) |
