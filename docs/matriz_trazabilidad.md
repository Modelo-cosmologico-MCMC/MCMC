...
| Canal Atlas de µ/η derivado desde la Acción de Gea (frente 3) | Acción de Gea (9.1) + Término de Cronos (9.4); Sello (9.3); ventana (9.4); H.2.2 | `cosmology/mu_eta_atlas.py` + `validation/atlas_derivation.py` | `tests/test_mu_eta_atlas.py` + `tests/test_mu_eta_atlas_lock.py` | derivación desde la acción verificada por cuatro vías (GR, Sello, cruce khronométrico, integración completa a 5e-4) — interna (E8); colas y PPN pendientes |
